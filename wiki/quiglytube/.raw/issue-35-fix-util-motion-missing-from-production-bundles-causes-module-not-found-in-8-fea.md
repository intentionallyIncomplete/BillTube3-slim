...
number: 35
state: CLOSED
title: "fix: util:motion missing from production bundles causes Module not found in 8+ features"
labels: "bug"
created: 2026-05-27T06:22:58Z
updated: 2026-05-27T06:46:52Z
url: https://github.com/intentionallyIncomplete/BillTube3-slim/issues/35
---

# GitHub Issue #35: fix: util:motion missing from production bundles causes Module not found in 8+ features
...
Add `modules/util-motion.js` as the **first file** in the `core` bundle in `scripts/build.js`, rebuild `dist/`, release, and optionally add an early explicit `BTFW.init("util:motion")` call in `billtube-fw.js` before feature inits for clearer boot ordering.
